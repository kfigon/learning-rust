...
fn multiple_trie() {
    ...
    assert_eq(t.find("a"), vec!["apple", "ape"]);
    assert_eq(t.find("ap"), vec!["apple", "ape"]);
    assert_eq(t.find("app"), vec!["apple"]);
    assert_eq(t.find("h"), vec!["hi", "hell", "hello"]);
    assert_eq(t.find("hell"), vec!["hell", "hello"]);
    assert_eq(t.find("hello"), vec!["hello"]);
    assert_eq(t.find(""), vec!["apple", "ape", "hi", "hello", "hell"]);
}

fn assert_eq(first: Vec<String>, second: Vec<&str>) {
